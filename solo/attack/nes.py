...
class NES(object):
    def __init__(self, model, nes_samples, sample_per_draw, p, max_queries, epsilon, step_size,
                data_name, search_sigma=0.02, decay=0.00, random_perturb_start=False, 
                target=False):
        self.model = model
        self.p = p
    ...
    def forward(self, xs, ys, ys_target=None, device=None): 
        adv_xs = []
        self.detail = {}
        self.device = device
